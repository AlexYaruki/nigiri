set(HEADERS "${CMAKE_SOURCE_DIR}/include/generic")

set(UNIX_HEADERS "${CMAKE_SOURCE_DIR}/include/unix")
set(LINUX_HEADERS "${CMAKE_SOURCE_DIR}/include/linux")
set(DARWIN_HEADERS "${CMAKE_SOURCE_DIR}/include/darwin")

set(WIN32_HEADERS "${CMAKE_SOURCE_DIR}/include/win32")

file(GLOB_RECURSE SOURCE_FILES "${CMAKE_SOURCE_DIR}/src/generic/*.cpp")

file(GLOB_RECURSE UNIX_SOURCE_FILES "${CMAKE_SOURCE_DIR}/src/unix/*.cpp")
file(GLOB_RECURSE LINUX_SOURCE_FILES "${CMAKE_SOURCE_DIR}/src/linux/*.cpp")
file(GLOB_RECURSE DARWIN_SOURCE_FILES "${CMAKE_SOURCE_DIR}/src/darwin/*.cpp")

file(GLOB_RECURSE WIN32_SOURCE_FILES "${CMAKE_SOURCE_DIR}/src/win32/*.cpp")

set(INPUT_FILES ${SOURCE_FILES})

set(DEBUG "no")
set(PLATFORM_LIKE_UNIX "no")
